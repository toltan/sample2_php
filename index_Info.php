	  ...
	  <div id="news">
		  <div class="newsTop">
			...
			<ul id="topics">
			  ...
			  <li id="topi"><a href="index_Info.php"><img src="images/topi2_roll.png" alt="info"></a></li>
			  <li><a href="index_Notice.php"><img src="images/topi3_roll.png" alt="notice"></a></li>
			</ul>
		  </div>
		  <div id="content">
			  <div id="wordpress">
			  <?php 
				 $po=array('posts_per_page' =>5,'category_name'=>Info);
				 $posts=get_posts($po);
				 foreach($posts as $p):?>
		  		<div class="cate">
					<div class="date">
